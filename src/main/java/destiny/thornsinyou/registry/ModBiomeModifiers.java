...
import destiny.thornsinyou.world.modifier.AddFeaturesByFilterBiomeModifier;
...
public class ModBiomeModifiers {
    ...
    static {
        BIOME_MODIFIER_SERIALIZERS = DeferredRegister.create(Keys.BIOME_MODIFIER_SERIALIZERS, "thornsinyou");
